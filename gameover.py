...
class GameOver(Entity):
    def __init__(self, game,sound):
        ...
        self.bg = Entity(parent=self,model='quad',texture='game_over_bg.jpg',position=(0,0.1),scale=(1.2,0.6))
        self.mess = Entity(parent=self,model='quad',texture='game_over.png',position=(0,0.06),scale=(1.5,1))
